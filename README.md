...
balls between your friends in the same local network using Sockets and also thanks to the nodeJS Service that has implemented socket.IO 
to manages all the states of the clients connected in real-time.
